function [gdata, st, newData] = applyRetroMC_nufft(kdata_in, alignMats, alignDim, alignIndices, useTable, dataDims_mm, fullMatrixDims, kspaceCentre, st, cgIterations, oversampFactor)
...
for iT = 1:Nt
    ...
    % Phase correction term goes here?
    fprintf('.');
end
fprintf('\n');
...
% Passed to function instead of recalculating for multi-channel coil data
%{
if useTable
