...
%
%
%       This function is copied from Sila's GRASP script as is. Modified by Serge - added MAGNETOM Vida check. 
%
%       INPUT:
...
function [  k22n, k3n, k_samples, dcf, totalSpokesInSeq, SliceOversampling, coilList2] = load_kspace_data( file, timePoints, spokesPerVol  )
    ...
    for i=1:size(file,1)
        ...
        elseif strcmp(scannerModel,'Skyra') || strcmp(scannerModel,'Prisma') || strcmp(scannerModel,'MAGNETOM Vida')  % sergev - adding details of VIDA scanner here also
