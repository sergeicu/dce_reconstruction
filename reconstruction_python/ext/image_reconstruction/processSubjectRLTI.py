...
sys.path.append('/home/ch199899/Documents/Research/DCE_all/image_reconstruction_XDgrasp/')
...
if __name__ == '__main__':
    ...
    # retrieve reference scan from SCANNER recon
    if args.referenceSCAN is None:
        ...
        referenceFileSCAN = args.referenceSCAN
    ...
    ## general params
    subjectListCSV = '/home/ch199899/Documents/Research/DCE/subjectList_MRU3.csv'
    ...
    ## Load k-sace data (use MATLAB script to save to /tmp/subjMRN_kspaceData.mat )
    if (not os.path.exists(kDataMatFile)):
        matFunctionCall = 'cd \'/home/ch199899/Documents/Research/DCE/\'; addpaths; try; loadAndSaveKspaceData( {\'%s\'}, \'%s\', %s, \'%s\', \'%s\' );catch; fprintf(\'SOMETHING WENT WRONG WHEN LOADING THE DATA\'); end;exit;' %(patientName,subjectListCSV,str(num_stokes_per_image),kDataMatFile, baseFolder )
